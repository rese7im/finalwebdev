...
if (mysqli_num_rows($select) != 0) {
    ...
    $name = $user['name'];
    $motto = isset($user['motto']) ? $user['motto'] : ''; // Check if 'motto' key exists
} else {
    $name = "";
    $motto = "";
}
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="header-text">
							<h2>hi <span>,</span> i am <br> <?php echo $name; ?><span>.</span>   </h2>
							<h2> <span></span> i firmly believe <br> <?php echo $motto; ?><span></span>   </h2>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="single-horizontal-timeline">
								<div class="experience-time">
									<h2>2018-2024</h2>
									<h3>bachelor <span>of </span> technology information</h3>
								</div><!--/.experience-time-->
								<div class="timeline-horizontal-border">
									<i class="fa fa-circle" aria-hidden="true"></i>
